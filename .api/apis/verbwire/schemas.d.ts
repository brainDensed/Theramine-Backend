...
declare const PostNftDeployDeploycontract: {
    readonly body: {
        ...
        readonly default: {
            readonly chain: "sepolia";
            readonly contractType: "nft721";
            readonly contractCategory: "simple";
            readonly isCollectionContract: false;
        };
        readonly $schema: "http://json-schema.org/draft-04/schema#";
    };
    readonly response: {
...
declare const PostNftMintCreatetoken1155: {
    readonly body: {
        ...
        readonly default: {
            readonly allowPlatformToOperateToken: true;
            readonly chain: "sepolia";
        };
        readonly $schema: "http://json-schema.org/draft-04/schema#";
    };
...
declare const PostTransfersUserclaimEmailAsset: {
    readonly body: {
        ...
        readonly default: {
            readonly chain: "sepolia";
            readonly claimType: "SINGLE_GASLESS_MINT";
        };
        readonly $schema: "http://json-schema.org/draft-04/schema#";
    };
    readonly response: {
